...
##number of processes and total number of circuit runs
#for this case i have
total_epsilon_parameters=3
total_R2_parameters=2
total_processes=6
total_runs=12
