...
for j in range(len(cutoffs)):
    ...
    file_path1='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/received_from_TACC/control_fidelity_results_{}'.format(cutoffs[j])
    ...
    file_path2='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/received_from_TACC/target_fidelity_results_{}'.format(cutoffs[j])
...
for l in range(len(cutoffs)):
    ...
    file_path1='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/analyzed_data_and_results/average_control_fidelity_results_{}'.format(cutoffs[l])
    ...
    file_path1='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/analyzed_data_and_results/sd_control_fidelity_results_{}'.format(cutoffs[l])
    with open(file_path1, 'wb') as f:
    ...
    file_path2='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/analyzed_data_and_results/average_target_fidelity_results_{}'.format(cutoffs[l])
    ...
    file_path2='/home/cnotgategkpstates/Desktop/evaluate_in_TACC_cutoff=40/analyzed_data_and_results/sd_target_fidelity_results_{}'.format(cutoffs[l])
    with open(file_path2, 'wb') as f:
